...
**Note:** This repository contains a specific implementation to be used in Roborrego's Dashgo robot. For a general xArm6 implementation, visit [this repo](https://github.com/edgarcancinoe/xArm6_DDPG_ROS).
